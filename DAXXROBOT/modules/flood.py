...
from DAXXROBOT import TIGERS, WOLVES, dispatcher
from DAXXROBOT.modules.connection import connected
from DAXXROBOT.modules.helper_funcs.alternate import send_message
...
from DAXXROBOT.modules.sql import antiflood_sql as sql
...
def flood(update, context):
    ...
    if limit == 0:
        text = (
            msg.reply_text(
                f"I'ᴍ ɴᴏᴛ ғᴏʀᴄɪɴɢ ᴀɴʏ ғʟᴏᴏᴅ ᴄᴏɴᴛʀᴏʟ ɪɴ  {chat_name}!"
            )
            if conn
            else msg.reply_text("ɪ'ᴍ ɴᴏᴛ ᴇɴғᴏʀᴄɪɴɢ  ᴀɴʏ ғʟᴏᴏᴅ ᴄᴏɴᴛʀᴏʟ ʜᴇʀᴇ!")
        )
    elif conn:
        text = msg.reply_text(
            f"ɪ'ᴍ ᴄᴜʀʀᴇɴᴛʟʏ ʀᴇsᴛʀɪᴄᴛɪɴɢ ᴍᴇᴍʙᴇʀs ᴀғᴛᴇʀ {limit} ᴄᴏɴsᴇᴄᴛɪᴠᴇ ᴍᴇssᴀɢᴇs. {chat_name}."
        )
    else:
        text = msg.reply_text(
            f"I'ᴍ ᴄᴜʀʀᴇɴᴛʟʏ ʀᴇsᴛʀɪᴄᴛɪɴɢ ᴍᴇᴍʙᴇʀ ᴀғᴛᴇʀ {limit} ᴄᴏɴsᴇᴄᴜᴛɪᴠᴇ ᴍᴇssᴀɢᴇs."
        )
