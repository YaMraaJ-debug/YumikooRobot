...
from DAXXROBOT import DRAGONS, LOGGER, dispatcher
from DAXXROBOT.modules.connection import connected
from DAXXROBOT.modules.disable import DisableAbleCommandHandler
from DAXXROBOT.modules.helper_funcs.alternate import send_message, typing_action
from DAXXROBOT.modules.helper_funcs.chat_status import user_admin
from DAXXROBOT.modules.helper_funcs.extraction import extract_text
from DAXXROBOT.modules.helper_funcs.filters import CustomFilters
from DAXXROBOT.modules.helper_funcs.handlers import MessageHandlerChecker
from DAXXROBOT.modules.helper_funcs.misc import build_keyboard_parser
from DAXXROBOT.modules.helper_funcs.msg_types import get_filter_type
...
from DAXXROBOT.modules.sql import cust_filters_sql as sql
...
def __stats__():
    return f"• {sql.num_filters()} ғɪʟᴛᴇʀs, ᴀᴄʀᴏss {sql.num_chats()} ᴄʜᴀᴛs."
