...
from DAXXROBOT.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from DAXXROBOT.modules.helper_funcs.string_handling import split_quotes
from DAXXROBOT.modules.log_channel import loggable
from DAXXROBOT.modules.sql import warns_sql as sql
    ...
    if num_warns >= limit:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "✨ ʀᴇᴍᴏᴠᴇ ✨", callback_data=f"rm_warn({user.id})"
                    )
                ]
            ]
        )
