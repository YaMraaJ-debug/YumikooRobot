...
import DAXXROBOT.modules.sql.blacklist_sql as sql
from DAXXROBOT import LOGGER, dispatcher
...
from DAXXROBOT.modules.helper_funcs.chat_status import user_admin, user_not_admin
from DAXXROBOT.modules.helper_funcs.extraction import extract_text
from DAXXROBOT.modules.helper_funcs.misc import split_message
from DAXXROBOT.modules.helper_funcs.string_handling import extract_time
from DAXXROBOT.modules.log_channel import loggable
from DAXXROBOT.modules.sql.approve_sql import is_approved
from DAXXROBOT.modules.warns import warn
...
def __stats__():
    return f"• {sql.num_blacklist_filters()} Bʟᴀᴄᴋʟɪsᴛ ᴛʀɪɢᴇʀs, ᴀᴄʀᴏss {sql.num_blacklist_filter_chats()} ᴄʜᴀᴛs."
