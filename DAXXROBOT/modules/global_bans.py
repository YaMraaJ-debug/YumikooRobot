...
import DAXXROBOT.modules.sql.global_bans_sql as sql
...
from DAXXROBOT.modules.helper_funcs.misc import send_to_list
from DAXXROBOT.modules.sql.users_sql import get_user_com_chats
