...
import DAXXROBOT.modules.sql.blacklistusers_sql as sql
from DAXXROBOT import DEMONS, DEV_USERS, DRAGONS, OWNER_ID, TIGERS, WOLVES, dispatcher
from DAXXROBOT.modules.helper_funcs.chat_status import dev_plus
from DAXXROBOT.modules.helper_funcs.extraction import (
    extract_user,
    extract_user_and_text,
)
from DAXXROBOT.modules.log_channel import gloggable
...
def bl_users(update: Update, context: CallbackContext):
    ...
    message = "<b>Blacklisted Users</b>\n" + (
        "None is being ignored as of yet." if not users else "\n".join(users)
    )
